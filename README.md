...
(also as [`report.pdf`](report.pdf), 15 pages) — the protocol, the proofs, the two
defects found in the handout's own two-party protocol, and the evaluation. This
...
| `report.pdf` | the full report, 15 pages |
